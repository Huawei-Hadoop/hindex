 ...
 * @see #usage()
 */
public class IndexLoadIncrementalHFiles extends LoadIncrementalHFiles {

  public final static String NAME = "indexcompletebulkload";

  public IndexLoadIncrementalHFiles(Configuration conf) throws Exception {
    super(conf);
  ...
  public static void main(String[] args) throws Exception {
    int ret = ToolRunner.run(new IndexLoadIncrementalHFiles(HBaseConfiguration.create()), args);
    System.exit(ret);
  }
}
