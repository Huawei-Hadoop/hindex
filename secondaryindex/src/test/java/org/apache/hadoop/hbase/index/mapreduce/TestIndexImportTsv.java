...
import org.apache.hadoop.hbase.index.mapreduce.IndexImportTsv.TsvParser;
import org.apache.hadoop.hbase.index.mapreduce.IndexImportTsv.TsvParser.BadTsvLineException;
import org.apache.hadoop.hbase.index.mapreduce.IndexImportTsv.TsvParser.ParsedLine;
...
public class TestIndexImportTsv {
  ...
  public void testMROnTable() throws Exception {
    ...
    String[] args =
        new String[] { "-D" + IndexImportTsv.COLUMNS_CONF_KEY + "=HBASE_ROW_KEY,FAM:A,FAM:B",
            "-D" + IndexImportTsv.SEPARATOR_CONF_KEY + "=\u001b", TABLE_NAME, INPUT_FILE };
  ...
  public void testMROnTableWithTimestamp() throws Exception {
    ...
    String[] args =
        new String[] {
            "-D" + IndexImportTsv.COLUMNS_CONF_KEY + "=HBASE_ROW_KEY,HBASE_TS_KEY,FAM:A,FAM:B",
            "-D" + IndexImportTsv.SEPARATOR_CONF_KEY + "=,", TABLE_NAME, INPUT_FILE };
  ...
  public void testMROnTableWithCustomMapper() throws Exception {
    ...
    String[] args =
        new String[] {
            "-D" + IndexImportTsv.MAPPER_CONF_KEY
                + "=org.apache.hadoop.hbase.mapreduce.TsvImporterCustomTestMapper", TABLE_NAME,
            INPUT_FILE };
  ...
  public void testBulkOutputWithoutAnExistingTable() throws Exception {
    ...
    String[] args =
        new String[] { "-D" + IndexImportTsv.COLUMNS_CONF_KEY + "=HBASE_ROW_KEY,FAM:A,FAM:B",
            "-D" + IndexImportTsv.SEPARATOR_CONF_KEY + "=\u001b",
            "-D" + IndexImportTsv.BULK_OUTPUT_CONF_KEY + "=output", TABLE_NAME, INPUT_FILE };
    doMROnTableTest(INPUT_FILE, FAMILY, TABLE_NAME, null, args, 3);
  }
